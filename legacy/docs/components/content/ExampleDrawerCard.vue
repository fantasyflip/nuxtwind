    ...
    >
      <template #custom-component>
        <div class="h-72 relative">
          <NXW-Appbar
            navigation-icon
            @navigation-icon-click="compProps.modelValue = !compProps.modelValue"
          >
          ...
          <NXW-Drawer
            v-model="compProps.modelValue"
            :overlay="compProps.overlay"
            :expand-on-hover="compProps['expand-on-hover']"
            height="h-full"
            absolute
            :disable-overflow="false"
            :border="compProps.border"
          >
            <div
